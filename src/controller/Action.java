...
public abstract class Action {
    ...
    //
    //maps from string ending with '.do' to action object that we want to invoke
    ...
    public static void add(Action a) {
    	synchronized (hash) {
    		...
    		//asks for name, and maps to action
    		hash.put(a.getName(),a);
    	}
    }
    //get action from hashmap
    public static String perform(String name,HttpServletRequest request) {
        ...
        //calls perform method on request. all actions have perform method
